<header>
    <div class="social-data">
        <div class="container">
            <div class="row">
                <div class="col-md-4 col-sm-4 col-xs-4 text-center" style="margin-top: 5px;">
                ...
                <div class="col-md-2 col-sm-6 col-xs-6 text-center" style="color: white;font-size: 1.5em;font-weight: bolder;">
                    <p>دار الرؤي للتدريب</p>
                </div>
                    ...
                    <div class="header-data">
                        <div class="row">
                            ...
                            <div class="col-md-4 col-xs-4 text-center">
                                ...
                                <div class="logo-img">
                                    <a href="{{route('site.home')}}">
                                        <img src="{{asset('assets/front/images/logo2.png')}}"
                                             alt="Techno One Logo" height="150">
                                    </a>
                                </div>
                            ...
                            <div class="col-md-4 col-xs-4 text-center">
                                ...
                                <div class="logo-img">
                                    <a href="{{route('site.home')}}">
                                        <img src="{{asset('assets/front/images/logo3.png')}}"
                                             alt="Techno One Logo" height="150">
                                    </a>
                                </div>
