            ...
            <div class="col-sm-3 col-xs-12">
                <div class="footer-menu wow fadeIn">
                    ...
                    <div>
                        ...
                        <a href="{{route('site.warranty')}}">{{__('messages.instructors')}}</a><br>
                        <a href="{{route('site.catalogs')}}">{{__('messages.about')}}</a><br>
                ...
                <div class="footer-about wow fadeIn">
                    ...
                    <div class="social-icons">
                        @foreach(\App\Models\Social::active()->selection()->get() as $social)
                            ...
                            <a target="_blank" href="{{$social->url}}"><i class="fa fa-{{$social->title}} fa-2x"></i></a>
