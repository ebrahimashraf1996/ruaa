                    ...
                    <div class="about-data wow">
                        @if(LaravelLocalization::getCurrentLocale() == 'ar')
                            <div class="col-md-6 col-xs-12 col-sm-12 text-center" style="margin: 10px 0px;">
                                <div class="wow fadeIn"  style="font-size: 18px">
                                    {!! $section->large_p !!}
                                </div>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-xs-12 text-center wow fadeIn" data-wow-duration="500ms"
                        ...
                        <div class="counters-item">
                            ...
                            <br>
                            <br>
                            <strong class="counter">100000</strong>
                            <br>
                            <br>
                            <p class="count_p">Satisfied Students</p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3 col-xs-12 text-center wow fadeIn" data-wow-duration="500ms"
                        ...
                        <div class="counters-item">
                            ...
                            <br>
                            <br>
                            <p class="count_p">Professional Courses</p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3 col-xs-12 text-center wow fadeIn" data-wow-duration="500ms"
                        ...
                        <div class="counters-item">
                            ...
                            <br>
                            <br>
                            <strong class="counter">2010</strong>
                            <br>
                            <br>
