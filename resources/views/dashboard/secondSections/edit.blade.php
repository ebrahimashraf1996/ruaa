                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form"
                                              action="{{route('admin.second.sections.update', $section->id)}}"
                                              method="POST"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="text-center col-md-6">
                                                    @if(str_ends_with($section->photo, '.jpg') || str_ends_with($section->photo, '.png') || str_ends_with($section->photo, '.jpeg'))<img style="width: 300px; height: 300px;" src="{{$section -> photo}}">@else لا يوجد @endif
                                                </div>
                                                <br><br><br>
                                                <br><br><br>
                                                <br><br><br>
...
{{--                                                    <div class="col-md-6">--}}
{{--                                                        <div class="form-group">--}}
{{--                                                            <label for="projectinput1"> اسم القسم بالإنجليزية--}}
{{--                                                            </label>--}}
{{--                                                            <input type="text" id="name"--}}
{{--                                                                   class="form-control"--}}
{{--                                                                   placeholder="  "--}}
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea type="text" id="name"
                                                                      ...
                                                                      name="content_ar">{{$section->content_ar}}</textarea>
                                                            @error("content_ar")
                                                            <span class="text-danger">{{$message}}</span>
                                                            @enderror
                                                        </div>
...
{{--                                                                      name="content_en">{{$section->content_en}}</textarea>--}}
{{--                                                            @error("content_en")--}}
{{--                                                            <span class="text-danger">{{$message}}</span>--}}
{{--                                                            @enderror--}}
{{--                                                        </div>--}}
