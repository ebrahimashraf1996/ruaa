                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"> الأنظمة والخواص
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">جميع الأنظمة والخواص </h4>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <a href="{{route('admin.offers.create')}}"
                                                   class="btn btn-outline-primary btn-min-width box-shadow-3 mr-1 mb-1">إضافة نظام او خاصية جديدة</a>
                                            </div>
                                        </div>
                                        <table
