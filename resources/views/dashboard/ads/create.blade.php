                                        ...
                                        <form class="form"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput1"> عنوان الإعلان
                                                            </label>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput1"> محتوي الإعلان
                                                            </label>
                                                            <textarea type="text" id="name"
                                                                      class="form-control height-150"
                                                                      placeholder=" ادخل محتوي الإعلان  "
...
{{--                                                </div>--}}
                                                ...
                                                <div class="row hidden" id="products_list" >
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label for="projectinput1"> اختر من قائمة الدعم الفني
                                                            </label>
                                                            &nbsp;
                                                            <select name="product_id" class="select2 form-control" style="width: 25%">
                                                                <optgroup label=" ">
                                                                    <option value="">                                                                        من فضلك أختر من قائمة الدعم الفني
                                                                    </option>
                                                ...
                                                <div class="row hidden"  id="offers_list">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label for="projectinput1"> اختر أحد الانظمة والخواص
                                                            </label>
                                                            &nbsp;
                                                            <select name="offer_id" class="select2 form-control" style="width: 25%">
                                                                <optgroup label=" ">
                                                                    <option value="">من فضلك أختر أحد الانظمة والخواص</option>
