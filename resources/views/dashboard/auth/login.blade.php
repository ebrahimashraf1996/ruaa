                ...
                <div class="card border-grey border-lighten-3 m-0">
                    <div class="card-header border-0">
                        <div class="card-title text-center">
                            <div class="p-1">
                                <img style="margin-bottom: -20px" width="250" height="250" src="{{asset('assets/front/images/logo3.png')}}" alt="LOGO"/>

                            </div>
                        </div>
                        <h6 style="margin-bottom: -10px" class="card-subtitle line-on-side text-muted text-center font-small-3 pt-2">
