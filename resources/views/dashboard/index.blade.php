...
{{--                @endif--}}
                ...
                <div class="row">
                    <div class="co-md-12 text-center block">
                        <h1 style="color: #9905ab; font-family: serif; font-weight: 900; font-size: 48px">لوحة تحكم موقع دار الرؤى</h1>
                    </div>
                    <div class="co-md-12 text-center block">
                        <img style="margin-top: 20px" width="360" height="300" src="{{asset('assets/front/images/logo1.png')}}" alt="LOGO"/>
                    </div>
                </div>
