                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"> قائمة الدعم الفني
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">قائمة الدعم الفني </h4>
                                            ...
                                            @isset($products)
                                                @foreach($products as $product)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><div  style=" overflow: hidden; height: 80px; width: 200px">{!! $product -> content_ar !!}</div></td>
{{--                                                        <td>{{$product -> title_en}}</td>--}}
{{--                                                        <td><div  style=" overflow: hidden; height: 80px; width: 200px">{{$product -> content_en}}</div></td>--}}
                                                        ...
                                                        <td>
                                                            ...
                                                            <div class="btn-group" role="group"
                                                                ...
                                                                <a href="{{route('admin.products.change.status',$product -> id)}}"
