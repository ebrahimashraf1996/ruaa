...
{{--                                            <div class="row">--}}
{{--                                                <div class="col-md-3">صورة الضمان</div>--}}
{{--                                                <div class="text-center col-md-6">--}}
{{--                                                    <img style="width: 300px; height: 300px;" src="{{$warranty -> photo}}">--}}
{{--                                                </div>--}}
{{--                                                <br><br><br>--}}
{{--                                                <br><br><br>--}}
{{--                                                <br><br><br><br><br><br>--}}
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea type="text" id="name"
                                                                      ...
                                                                      name="content_ar">{{$warranty->content_ar}}</textarea>
                                                            @error("content_ar")
                                                            <span class="text-danger">{{$message}}</span>
                                                            @enderror
                                                        </div>
...
{{--                                                                      name="content_en">{{$warranty->content_en}}</textarea>--}}
{{--                                                            @error("content_en")--}}
{{--                                                            <span class="text-danger">{{$message}}</span>--}}
{{--                                                            @enderror--}}
{{--                                                        </div>--}}
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group mt-1">
                                                            <input type="checkbox" value="1"
                                                                   ...
                                                                   @if($warranty -> is_active == 1) checked @endif/>
