<div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-="true">
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item"><a href=""><i class="la la-male"></i>
                    <span class="menu-title" data-i18n="nav.dash.main"> الأنظمة والخواص  </span>
                    <span
            ...
            <li class="nav-item"><a href=""><i class="la la-male"></i>
                    <span class="menu-title" data-i18n="nav.dash.main"> الدعم الفني  </span>
                    <span
            ...
            <li class="nav-item"><a href=""><i class="la la-male"></i>
                    <span class="menu-title" data-i18n="nav.dash.main">آلية ومنع الغش  </span>
                    <span
                        class="badge badge badge-success  badge-pill float-right mr-2">{{\App\Models\CertificationP::count()}}</span>
                </a>
                <ul class="menu-content">
                    <li class=""><a class="menu-item" href="{{route('admin.certificate')}}"
                                          data-i18n="nav.dash.ecommerce"> عرض الكل </a>
                    </li>
                    <li><a class="menu-item" href="{{route('admin.certificate.create')}}" data-i18n="nav.dash.crypto">إضافة
                            عنصر </a>
                    </li>
                </ul>
            </li>
...
{{--            <li class="nav-item"><a href=""><i class="la la-male"></i>--}}
{{--                    <span class="menu-title" data-i18n="nav.dash.main">آلية منع الغش  </span>--}}
{{--                    <span--}}
{{--                        class="badge badge badge-success  badge-pill float-right mr-2">{{\App\Models\CertificationP::count()}}</span>--}}
{{--                </a>--}}
{{--                <ul class="menu-content">--}}
...
{{--            </li>--}}
            ...
            <li class="nav-item"><a href=""><i class="la la-male"></i>
                    <span class="menu-title" data-i18n="nav.dash.main">قسم عنا  </span>
                    <span
...
{{--            </li>--}}
            ...
            <li class="nav-item"><a href=""><i class="la la-male"></i>
                    <span class="menu-title" data-i18n="nav.dash.main">المدربون  </span>
                    <span
