...
<head><title>@yield('title')</title>
    ...
    <link rel="apple-touch-icon" href="{{asset('assets/front/images/logo3.png')}}">
    <link rel="shortcut icon" type="image/x-icon" href="{{asset('assets/front/images/logo3.png')}}">
...
<div class="preloader-wrapper">
    <div class="preloader">
        <img src="{{asset('assets/front/images/logo1.png')}}" alt="loader">
    </div>
</div>
...
<section class="copy text-center" dir="ltr">
    <p class="wow fadeIn"><span class="cr" style="color: #daa238;">Dar Al-Ruaa</span>
        - <a href="{{route('site.copyRight')}}" style="color: #4444c7; text-decoration: none" target="_blank">
            All Rights Reserved
        </a> {{date('Y')}}.
    </p>
</section>
