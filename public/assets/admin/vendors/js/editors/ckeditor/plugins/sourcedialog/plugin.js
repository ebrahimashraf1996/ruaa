...
CKEDITOR.plugins.add( 'sourcedialog', {
	...
	lang: 'af,ar,bg,bn,bs,ca,cs,cy,da,de,de-ch,el,ar,ar-au,ar-ca,ar-gb,eo,es,et,eu,fa,fi,fo,fr,fr-ca,gl,gu,he,hi,hr,hu,id,is,it,ja,ka,km,ko,ku,lt,lv,mn,ms,nb,nl,no,pl,pt,pt-br,ro,ru,si,sk,sl,sq,sr,sr-latn,sv,th,tr,tt,ug,uk,vi,zh,zh-cn', // %REMOVE_LINE_CORE%
