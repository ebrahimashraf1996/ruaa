...
$(document).ready(function(){
    ...
    **********************************************/
    i18next
        ...
        .init({
            //lng: 'ar', // evtl. use language-detector https://github.com/i18next/i18next-browser-languageDetector
            resources: { // evtl. load via xhr https://github.com/i18next/i18next-xhr-backend
                ...
                es: {
                    translation: {
                        key: "A nosotros mismos la dirección de creer que él partida. Celebraba sus sentimientos entendidos que estaban proyectados. Posesión no hay ningún señor notablemente afectado. Escribí la casa ar nunca fructificar. Pasto imaginar mis garrets y él. Por muy distante que se lo pidiera, no veía nada. Hablar se estableció ar un tiempo contento de mi hermano."
                    }
                },
                pt: {
                    translation: {
